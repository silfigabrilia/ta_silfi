...
public class Vitamin_A extends AppCompatActivity {

    private ProgressDialog pDialog;
    private static String URL_VitaminA = "https://sistempakarta.000webhostapp.com/android/get_vitamin_a.php";
    private ListView lv;
    ...
    private void displayLoader() {
        pDialog = new ProgressDialog(Vitamin_A.this);
    ...
    private void getVitaminA() {
        displayLoader();

        RequestQueue queue = Volley.newRequestQueue(Vitamin_A.this);
        JsonObjectRequest jsArrayRequest = new JsonObjectRequest(Request.Method.GET, URL_VitaminA, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                pDialog.dismiss();
                try {
                    if (response.getInt("status") == 0) {
                        JSONArray jsonArray = response.getJSONArray("vitamin_a");
