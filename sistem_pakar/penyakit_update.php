...
<div class="box box-success">
    <div class="box-header with-border">
        <h3 class="box-title">Data Tingkat Gizi</h3>
    </div>
    <form class="form-horizontal" action="<?php echo $link_update; ?>" method="post">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                <label for="kode_penyakit" class="col-sm-2 control-label">Kode Tingkat Gizi</label>
                <div class="col-sm-4">
                    <input name="kode_penyakit" id="kode_penyakit" class="form-control" required type="text" value="<?php echo $kode_penyakit; ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="nama_penyakit" class="col-sm-2 control-label">Tingkat Gizi</label>
                <div class="col-sm-4">
